...
source ~/.config/nvim/conf/interface.vim
source ~/.config/nvim/conf/auto.vim
source ~/.config/nvim/conf/commands.vim
source ~/.config/nvim/conf/mappings.vim
source ~/.config/nvim/conf/lh.vim

source ~/.config/nvim/conf/plugin/ale.vim
...
source ~/.config/nvim/conf/plugin/vim-airline.vim
source ~/.config/nvim/conf/plugin/vim-go.vim
source ~/.config/nvim/conf/plugin/vim-javascript.vim
source ~/.config/nvim/conf/plugin/vim-jsx.vim
source ~/.config/nvim/conf/plugin/vim-move.vim
source ~/.config/nvim/conf/plugin/vimwiki.vim
